...
$('.language').click(function () {
    ...
    var lang = 'US';
    if (this.getAttribute('data-option') == "ru_RU") {
        lang = "RU";
    }
    this.parentNode.parentNode.parentNode.firstChild.nextSibling.firstChild.nextSibling.setAttribute('class', 'glyphicon bfh-flag-' + lang);
